...
import { WA_NUMBER, TEL, TEL_DISPLAY, EMAIL, WhatsAppIcon } from "../components/icons";
...
/* ── Slider helper ───────────────────────────────────────── */
/** Returns the CSS background for a filled-track range input.
 *  pct = 0–100 (percentage of thumb position along the track). */
...
/* ── MiniToggle — replaces dropdowns for motor options ──── */
...
function CoverageCalculator({
  ...
  // Animate premium value when it changes
  ...
  // Pulse animation when premium number changes
  useEffect(() => {
    ...
    return (
      <div className="form-card" style={{ textAlign: "center", padding: "2.5rem 1.5rem" }}>
        ...
        <p style={{ fontSize: "0.85rem", color: "var(--color-ink-3)" }}>
          📱 Direct WhatsApp: <strong>+91 99400 89442</strong>
        </p>
        <button
...
function Home() {
  ...
  // Autoplay loop for testimonials
  useEffect(() => {
